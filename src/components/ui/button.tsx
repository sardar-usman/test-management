...
export function Button({
  ...
  const styles: Record<Variant, string> = {
    ...
    draft: "border border-zinc-400 bg-white text-zinc-800 hover:bg-zinc-50",
    duplicate: "bg-violet-600 text-white hover:bg-violet-700",
    delete: "border border-rose-200 bg-rose-50 text-rose-600 hover:bg-rose-100",
    edit: "border border-indigo-200 bg-indigo-50 text-indigo-600 hover:bg-indigo-100",
  };
